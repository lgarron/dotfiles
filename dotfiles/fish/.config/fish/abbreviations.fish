...
for dns_connecting_command in ssh mosh sshping ping host iperf3
    ...
    abbr_anyarg $dns_connecting_command sl Styx.lan
    ...
    abbr_anyarg $dns_connecting_command sw Styx-ts.wyvern-climb.ts.net
...
for ip_connecting_command in ping
    ...
    abbr_anyarg $ip_connecting_command 8 8.8.8.8
end
...
function abbr_brew_l_fn
    _abbr_expand_anyarg brew l "--HEAD lgarron/lgarron/%" commit
end
abbr -a abbr_brew_l --regex l --position anywhere --function abbr_brew_l_fn --set-cursor
function abbr_brew_ll_fn
    _abbr_expand_anyarg brew ll "lgarron/lgarron/%" commit
end
abbr -a abbr_brew_ll --regex ll --position anywhere --function abbr_brew_ll_fn --set-cursor
function abbr_brew_cc_fn
    _abbr_expand_anyarg brew cc "cubing/cubing/%" commit
end
abbr -a abbr_brew_cc --regex cc --position anywhere --function abbr_brew_cc_fn --set-cursor
