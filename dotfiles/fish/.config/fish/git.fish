...
function _abbr_git_commit_message_fn
    _abbr_expand_subcommand_arg git m "--message \"%\"" commit
end
...
function _abbr_git_commit_last_command_fn
    _abbr_expand_subcommand_arg git !! "--message \"`"(string replace --all "\"" "\\\"" $history[1])"`\"" commit
end
abbr -a _abbr_git_commit_last_command --regex !! --position anywhere --function _abbr_git_commit_last_command_fn
# git commit !!!⎵ → git commit --message "`[second-to-last command]`" ( TODO: remove the second space?)
function _abbr_git_commit_secondlast_command_fn
    _abbr_expand_subcommand_arg git !!! "--message \"`"(string replace --all "\"" "\\\"" $history[2])"`\"" commit
end
abbr -a _abbr_git_commit_secondlast_command --regex !!! --position anywhere --function _abbr_git_commit_secondlast_command_fn
# git commit !!!!⎵ → git commit --message "`[third-to-last command]`" ( TODO: remove the second space?)
function _abbr_git_commit_thirdlast_command_fn
    _abbr_expand_subcommand_arg git !!! "--message \"`"(string replace --all "\"" "\\\"" $history[3])"`\"" commit
end
abbr -a _abbr_git_commit_thirdlast_command --regex !!! --position anywhere --function _abbr_git_commit_thirdlast_command_fn
