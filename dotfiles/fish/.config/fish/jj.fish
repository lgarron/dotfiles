...
abbr -a jpt "set FIRST_BOOKMARK (jj guess-branch | head -n 1) && jj bookmark set --revision here \$FIRST_BOOKMARK && jj git push --bookmark \$FIRST_BOOKMARK && git switch \$FIRST_BOOKMARK || jj new \$FIRST_BOOKMARK"
